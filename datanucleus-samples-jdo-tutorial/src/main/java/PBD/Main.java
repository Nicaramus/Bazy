...
//        // Persistence of a Product and a Book.
	...
	Conference conf1 = new Conference("conf1", new Timestamp(121, 12, 21, 10, 23, 12, 12), new Timestamp(121, 12, 29, 10, 23, 12, 12), 20, 50.5);
    	Conference conf2 = new Conference("conf2", new Timestamp(121, 12, 21, 10, 23, 12, 12), new Timestamp(121, 12, 22, 10, 23, 12, 12), 100, 10);
	Conference conf3 = new Conference("conf3", new Timestamp(121, 12, 21, 10, 23, 12, 12), new Timestamp(121, 12, 21, 10, 24, 12, 12), 80, 24);
    	Conference conf4 = new Conference("conf4", new Timestamp(121, 12, 21, 10, 23, 12, 12), new Timestamp(121, 12, 30, 10, 23, 12, 12), 30, 400);
    	/*	
	conf1.buyTicket(10);
	conf1.buyTicket();
...
// +
		...
		Timestamp totime = new Timestamp(121, 12, 23, 10, 23, 12, 12);
            ...
            while (iter.hasNext())
            {
                ...
                System.out.println(">  " + p  + "  number of ticekts " + p.getFreeTickets() + "  number of reservations " + p.getReservations());
	...
	q.setFilter("title == 'conf3'");
	 List<Conference> selectConf = (List<Conference>)q.execute();
		...
		//String formattedDate = new SimpleDateFormat("yyyyMMdd").format(date);
                ...
                System.out.println(">  " + p.getTitle() + " startDate :" + p.getStart_date() + " number of ticekts " + p.getFreeTickets() + " number of reservations " + p.getReservations());
